...
export default function LoginPage() {
  ...
  return (
    <main className="login-page login-page--single relative isolate grid min-h-dvh w-full box-border place-items-center overflow-hidden bg-[radial-gradient(circle_at_18%_18%,rgba(255,190,112,.34),transparent_25rem),radial-gradient(circle_at_82%_82%,rgba(232,75,66,.2),transparent_27rem),linear-gradient(145deg,#fffaf6,#fff1ea)] px-4 py-3 sm:px-5 sm:py-8">
      ...
      <section className="login-panel login-panel--single grid min-h-0 w-full max-w-full box-border place-items-center bg-transparent p-0">
        <div className="login-shell grid w-[calc(100vw-32px)] max-w-[470px] box-border justify-items-stretch overflow-hidden sm:w-full">
          ...
          <div className="login-card box-border w-full max-w-full rounded-2xl border border-[#e5d2cb]/90 bg-white/90 p-4 shadow-[0_18px_45px_rgba(101,54,46,.12)] backdrop-blur-xl sm:p-8 sm:shadow-[0_28px_70px_rgba(101,54,46,.14)]">
            <div className="login-card__heading mb-4 text-center sm:mb-5"><span className="eyebrow text-[0.62rem] font-extrabold uppercase tracking-[0.1em] text-brand-600 sm:text-[0.68rem] sm:tracking-[0.12em]">Welcome back</span><h2 className="mb-1.5 mt-1.5 text-[1.65rem] font-extrabold tracking-[-0.04em] text-[#342326] sm:mb-2 sm:mt-2 sm:text-4xl">Sign in</h2><p className="m-0 text-xs text-[#74676a] sm:text-sm">Everything you need for today's service.</p></div>
